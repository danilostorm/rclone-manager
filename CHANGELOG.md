...
## Release unificada 1.7.8 — Unraid 1.7.8 / ZorinOS 1.3.8 / VPS 1.0.9 / Extensão 1.2.3

- consolida correções acumuladas de fila, retry, gerenciamento de pastas e Google Drive avançado anteriores ao Media Pool;
- mantém a publicação unificada das quatro edições e a cadeia reproduzível usada como base para a 1.9.0.
